/**
 * @title webPractice / DBviewer / DataSourceConnect.java
...
public class DataSourceConnect {
    ...
    public static void main(String[] args) {
        new DataSourceConnect().connectDB();
    }//main()
}//class
...
javax.naming.NoInitialContextException: Need to specify class name in environment or system property, or in an application resource file: java.naming.factory.initial
    ...
    at webPractice.DBviewer.DataSourceConnect.connectDB(DataSourceConnect.java:17)
    at webPractice.DBviewer.DataSourceConnect.main(DataSourceConnect.java:33)
Exception in thread "main" java.lang.NullPointerException
    at webPractice.DBviewer.DataSourceConnect.connectDB(DataSourceConnect.java:25)
    at webPractice.DBviewer.DataSourceConnect.main(DataSourceConnect.java:33)
