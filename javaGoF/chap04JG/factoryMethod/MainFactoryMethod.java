 ...
 * @date 2021-04-17
 */
package javaGoF.chap04JG.factoryMethod;

import java.util.List;
import java.util.Map;
import java.util.Map.Entry;

import javaGoF.chap04JG.factoryMethod.framework.Factory;
import javaGoF.chap04JG.factoryMethod.framework.Product;
import javaGoF.chap04JG.factoryMethod.idCard.IdCardFactory;
