/**
 * @title javaGoF / chap18Memento / MainFruitGame.java
 * @reference 結城 浩 『Java言語で学ぶデザインパターン入門 [増補改訂版]』 SB Creative, 2004
 * @content 第18章 Memento / List 18-1, 18-2, 18-3
 *          状態を記録する Mementoインスタンス。
 *          Mementoは package-privateで、
 *          narrow interface / wide interfaceの区別をつけ、
 *          クラスによって公開する範囲を変化させることにより、
 *          「カプセル化の破壊」を防止する。
 *
...
import javaGoF.chap18Memento.fruitGame.GamerFruit;
